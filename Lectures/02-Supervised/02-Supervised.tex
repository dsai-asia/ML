...
\mode<presentation>
{
  ...
  \pgfdeclareimage[height=3em,interpolate=true]{aitlogo}{../../ait-logo}
  ...
  \titlegraphic{\pgfuseimage{dsailogo} \hspace{0.2in} \pgfuseimage{erasmuslogo} \hspace{0.2in} \pgfuseimage{aitlogo}}
  %\usetheme{default}
  \usetheme{Madrid}
  \usecolortheme{rose}
